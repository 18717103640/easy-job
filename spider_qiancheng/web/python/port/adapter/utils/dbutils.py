...
class DBUtils:
    ...
    DB_HOST = get_common_config('database', 'host')
    DB_USER = get_common_config('database', 'user')
    DB_PASSWORD = str(get_common_config('database', 'password'))
    DB_NAME = get_common_config('database', 'db_name')
    DB_PORT = get_common_config('database', 'port')
    DB_CHARSET = get_common_config('database', 'db_charset')
